...
My research interests lie at the intersection of NLP and HCI, particularly in how people interact with, evaluate, and learn from AI systems. My current work spans LLM benchmarking and evaluation (e.g., [Sci2Pol](https://iclr.cc/virtual/2026/poster/10009432)), human adjudication and decision-making over LLM outputs (e.g., Models of Humans for Adjudicating AI Debate), and the design and study of technologies that support human learning processes (e.g., A Corpus-Grounded Interface for Student Writing Revision).
